      ...
      <div className="max-w-4xl mx-auto w-full px-6 py-12 flex-1 flex flex-col">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
          ...
          >
            ...
            <h2 className="text-xl font-semibold mb-2">Construcción</h2>
            <p className="text-sm text-zinc-400 leading-relaxed mb-4">
              PM observa una obra activa: entregas, cuadrillas, gastos. El agente detecta
              sobregastos, actividad fuera de horario, proveedores no autorizados, entregas
              duplicadas. Score = <b>Project Health</b>.
            </p>
          ...
          >
            ...
            <p className="text-sm text-zinc-400 leading-relaxed mb-4">
              Distribuidor / bodega como colateral de un préstamo. El agente detecta
              mermas, productos lentos, shocks de precio de mercado, sub-colateralización.
              Score = <b>Collateral Readiness</b>.
            </p>
            <p className="text-xs text-zinc-500 group-hover:text-zinc-300">
              ir al panel →
            </p>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm text-zinc-400 mb-10">
          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-4">
            ...
            <p>
              Claude Managed Agents Sessions (beta). 4 tools custom: <code>query_project_state</code>,
              <code> log_event</code>, <code>flag_anomaly</code>, <code>recompute_score</code>.
              Sesión persistente por evento — auditable.
            </p>
          </div>
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-4">
            <p className="text-[10px] uppercase tracking-wider text-zinc-500 mb-1">Salida</p>
            <p>
              Panel en tiempo casi real, score compuesto 0–100 con 4 componentes, y
              una traza completa por evento — evidencia para un lender.
            </p>
          </div>
        </section>
